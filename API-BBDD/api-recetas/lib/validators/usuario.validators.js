...
const validadorUsuario = [check('nombres').exists().withMessage("Favor debe ir el atributo nombre y apellido").notEmpty().withMessage("Favor este campo debe venir con informacion"), check('user').exists().withMessage("Favor debe ir el atributo nombre de usuario").notEmpty().withMessage("Favor este campo debe venir con informacion"), check('password').exists().withMessage("Favor debe ir el atributo password").notEmpty().withMessage("Favor este campo debe venir con informacion").isLength({
  min: 8,
  max: 16

...
const validadorUsuario = [check('nombre').exists().withMessage("Favor debe ir el atributo nombre").notEmpty().withMessage("Favor este campo debe venir con informacion"), check('apellido').exists().withMessage("Favor debe ir el atributo apellido").notEmpty().withMessage("Favor este campo debe venir con informacion"), check('correo').exists().withMessage("Favor debe ir el atributo correo Ejemplo: correo@gmail.com").notEmpty().withMessage("Favor este campo debe venir con informacion").isLength({
  min: 5
  ...
  min: 8,
  max: 16
}).withMessage("El minimo de caracteres son 8 y el maximo son 16"), check('activo').exists().withMessage("Favor debe ir el atributo activo").notEmpty().withMessage("Favor este campo debe venir con informacion").isInt({
  min: 0,
  max: 1
